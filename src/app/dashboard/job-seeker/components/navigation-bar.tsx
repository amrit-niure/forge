...
const navItems = [
  ...
  { href: "/dashboard/job-seeker/profile", label: "Profile" },
  { href: "/dashboard/job-seeker/applied-jobs", label: "Applied Jobs" },
  { href: "/dashboard/job-seeker/saved-jobs", label: "Saved Jobs" },
  { href: "/dashboard/job-seeker/saved-companies", label: "Saved Companies" },
